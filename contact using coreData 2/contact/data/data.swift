...
//        let contact = Contacts(firstName: firstName, secondName: secondName, mobile: number)
...
//    }
    func makeArray(){
//        for i in 0..<numbersArr.count{
//            allContacts.create(contact: Contacts(firstName: firstNamesArr[i], secondName: secondNamesArr[i], mobile: numbersArr[i], id: UUID()))
//        }
